  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-black text-white flex flex-col relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-1/3 -right-24 w-96 h-96 bg-blue-50/20 rounded-full blur-3xl opacity-70 animate-pulse-soft"></div>
        <div className="absolute bottom-20 left-40 w-32 h-32 border border-blue-100/20 rounded-full animate-float opacity-30"></div>
        <div className="absolute top-40 right-20 w-24 h-24 border border-blue-100/20 rounded-full animate-float opacity-30" style={{ animationDelay: '2s' }}></div>
      </div>
